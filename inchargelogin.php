...
<body style="color: black;background-image: url(image.jpeg);background-size: 100%;background-repeat: no-repeat;back">
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;"><b>Crime Portal 2022<b></h4>
</div>
